...
///
/// @defgroup Systems Systems features
///
/// @brief Features that implement in C++ the GLSL specification as closely as possible.
///
/// The GLM Systems consists of C++ types that mirror GLSL types and
/// C++ functions that mirror the GLSL functions.
///
/// The best documentation for GLM Systems is the current GLSL specification,
/// <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.clean.pdf">version 4.2
/// (pdf file)</a>.
///
/// GLM Systems functionalities require <glm/glm.hpp> to be included to be used.
///
///
/// @defgroup Systems_vector Vector types
///
...
///
///
/// @defgroup Systems_vector_precision Vector types with precision qualifiers
///
...
///
///
/// @defgroup Systems_matrix Matrix types
///
...
///
///
/// @defgroup Systems_matrix_precision Matrix types with precision qualifiers
///
